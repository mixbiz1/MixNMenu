    ...
    with engine.begin() as conn:
        ...
        BEGIN
          IF EXISTS(SELECT 1 FROM dbo.tb_menu_master WHERE menu_code='PURCHASE_GENERAL')
            UPDATE dbo.tb_menu_master SET menu_name=N'일반 매입등록',menu_group=N'상품입/출고관리',sort_order=210,use_yn=1 WHERE menu_code='PURCHASE_GENERAL';
          ELSE INSERT dbo.tb_menu_master(menu_code,menu_name,menu_group,sort_order,use_yn) VALUES('PURCHASE_GENERAL',N'일반 매입등록',N'상품입/출고관리',210,1);
